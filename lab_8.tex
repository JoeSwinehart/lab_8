...
We used R (Version 4.0.2; R Core Team, 2020) and the R-packages \emph{here} (Version 0.1; Müller, 2017), \emph{papaja} (Version 0.1.0.9997; Aust \& Barth, 2020), and \emph{readr} (Version 1.4.0; Wickham \& Hester, 2020) for all our analyses.
